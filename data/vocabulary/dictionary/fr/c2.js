const c2_french_vocabulary = {
  "Maîtrise Exceptionnelle du Vocabulaire Général et Spécialisé": [
    { "term": "ineffable", "definition": "Qui ne peut être exprimé par des paroles, indicible.", "gender": null, "example": "Une joie ineffable.", "notes": "Très soutenu." },
  ...
  "Créativité Lexicale et Jeu de Mots": [
    ...
    { "term": "un calembour", "definition": "Jeu de mots fondé sur l'homophonie ou la polysémie.", "gender": "m", "example": "Il adore faire des calembours, même s'ils ne sont pas toujours drôles.", "notes": "" },
    { "term": "un hapax", "definition": "Mot qui n'apparaît qu'une seule fois dans un corpus donné.", "gender": "m", "example": "Ce terme est un hapax dans l'œuvre de cet auteur.", "notes": "Terme de linguistique/stylistique." },
    { "term": "la paronomase", "definition": "Figure de style qui rapproche des mots de sonorités voisines mais de sens différents.", "gender": "f", "example": "'Qui se ressemble s'assemble' est un exemple de paronomase.", "notes": "Rhétorique." },
    { "term": "un mot-valise", "definition": "Mot formé par la fusion d'au moins deux mots existants (ex: franglais).", "gender": "m", "example": "'Courriel' est un mot-valise (courrier électronique).", "notes": "" }
  ],
  "Terminologie de Domaines Hautement Spécialisés": [
    // Exemple: Philosophie
    { "term": "l'aporie", "definition": "Difficulté d'ordre rationnel paraissant sans issue.", "gender": "f", "example": "Les apories de Zénon sur le mouvement.", "notes": "Philosophie." },
    // Exemple: Droit
    { "term": "la jurisprudence", "definition": "Ensemble des décisions des tribunaux sur une matière ; solution faisant autorité.", "gender": "f", "example": "La jurisprudence en matière de droit du travail.", "notes": "Droit." },
    // Exemple: Médecine
    { "term": "une étiologie", "definition": "Étude des causes des maladies.", "gender": "f", "example": "L'étiologie de cette pathologie reste incertaine.", "notes": "Médecine." },
    // Exemple: Linguistique
    { "term": "la phonologie", "definition": "Étude des sons d'une langue du point de vue de leur fonction.", "gender": "f", "example": "La phonologie du français contemporain.", "notes": "Linguistique." },
    // Exemple: Économie
    { "term": "l'oligopole", "definition": "Marché caractérisé par un petit nombre de vendeurs face à une multitude d'acheteurs.", "gender": "m", "example": "Le secteur des télécommunications est souvent un oligopole.", "notes": "Économie." }
  ],
  "Compréhension et Utilisation de Langue Ancienne ou Très Formelle": [
  ...
  "Analyse Critique du Discours et de la Langue": [
    ...
    { "term": "un acte de langage", "definition": "Énoncé considéré du point de vue de l'action qu'il accomplit (promettre, ordonner, etc.).", "gender": "m", "example": "'Je te promets' est un acte de langage performatif.", "notes": "Linguistique." },
    { "term": "la connotation", "definition": "Sens second, subjectif, associé à un mot ou à une expression.", "gender": "f", "example": "Ce mot a une connotation péjorative.", "notes": "" },
    { "term": "la dénotation", "definition": "Sens premier, objectif et stable d'un mot, tel qu'il est défini dans le dictionnaire.", "gender": "f", "example": "La dénotation du mot 'rouge' est une couleur.", "notes": "" },
    { "term": "un présupposé", "definition": "Information implicite que l'on doit admettre pour qu'un énoncé soit pertinent.", "gender": "m", "example": "L'énoncé 'Pierre a cessé de fumer' a pour présupposé que Pierre fumait avant.", "notes": "Linguistique." }
  ],
  "Termes Philosophiques et Théoriques Complexes": [
    { "term": "la phénoménologie", "definition": "Étude philosophique des phénomènes, de la manière dont les choses apparaissent à la conscience.", "gender": "f", "example": "La phénoménologie de Husserl.", "notes": "Philosophie." },
    { "term": "l'herméneutique (philosophique)", "definition": "Théorie de l'interprétation, notamment des textes et des actions humaines.", "gender": "f", "example": "L'herméneutique de Gadamer.", "notes": "Philosophie." },
    { "term": "le structuralisme", "definition": "Courant de pensée qui appréhende la réalité sociale et culturelle comme un ensemble de relations structurelles.", "gender": "m", "example": "Le structuralisme en linguistique et en anthropologie.", "notes": "Sciences humaines." },
    { "term": "le post-structuralisme", "definition": "Ensemble de courants critiques qui ont suivi et remis en question le structuralisme.", "gender": "m", "example": "Foucault et Derrida sont associés au post-structuralisme.", "notes": "Philosophie/Théorie littéraire." },
    { "term": "la déconstruction", "definition": "Méthode d'analyse textuelle initiée par Derrida, visant à mettre en évidence les contradictions internes et les présupposés d'un texte.", "gender": "f", "example": "Appliquer la déconstruction à un texte philosophique.", "notes": "Philosophie/Théorie littéraire." }
  ],
  "Langage de la Négociation et de la Diplomatie de Haut Niveau": [
...
export default c2_french_vocabulary;
