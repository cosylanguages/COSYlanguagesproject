...
const EventForm = () => {
  ...
  return (
    <form className="event-form" onSubmit={handleSubmit}>
      ...
      <input type="text" placeholder="URL de la vidéo" value={videoUrl} onChange={(e) => setVideoUrl(e.target.value)} />
      <input type="text" placeholder="Titre de la vidéo" value={videoTitle} onChange={(e) => setVideoTitle(e.target.value)} />
